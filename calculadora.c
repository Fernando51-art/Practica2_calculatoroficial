...
void fnExecuteOperationState(tStateMachine * MaqEstado, tCalcData * DatosCalc) {
	...
	if(DatosCalc->bOperator=='+'){DatosCalc->wResult=DatosCalc->bFirstData+DatosCalc->bSecondData;}
		else if(DatosCalc->bOperator=='-'){DatosCalc->wResult=DatosCalc->bFirstData-DatosCalc->bSecondData;}
		else if(DatosCalc->bOperator=='/'){DatosCalc->wResult=DatosCalc->bFirstData/DatosCalc->bSecondData;}
		else if(DatosCalc->bOperator=='*'){DatosCalc->wResult=DatosCalc->bFirstData*DatosCalc->bSecondData;}
		else if(DatosCalc->bOperator=='%'){DatosCalc->wResult=DatosCalc->bFirstData%DatosCalc->bSecondData;}
